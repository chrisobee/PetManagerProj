...
{
    public partial class ReestablishDBs : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PetOwnerId1 = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PetOwners", x => x.PetOwnerId);
                    table.ForeignKey(
                        name: "FK_PetOwners_AspNetUsers_IdentityUserId",
                        column: x => x.IdentityUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PetOwners_PetOwners_PetOwnerId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaskInterval = table.Column<TimeSpan>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PetHumanJxnId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PetOwnerId = table.Column<int>(nullable: false),
                    PetId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PetOwnerships", x => x.PetHumanJxnId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PetOwnerships_PetOwners_PetOwnerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PetOwners_IdentityUserId",
                table: "PetOwners",
                column: "IdentityUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PetOwners_PetOwnerId1",
                table: "PetOwners",
                column: "PetOwnerId1");

            migrationBuilder.CreateIndex(
                name: "IX_PetOwnerships_PetId",
                table: "PetOwnerships",
                column: "PetId");

            migrationBuilder.CreateIndex(
                name: "IX_PetOwnerships_PetOwnerId",
                table: "PetOwnerships",
                column: "PetOwnerId");
